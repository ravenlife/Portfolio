...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th width="8%">
				<?= @helper('grid.sort', array('column' => 'user_id', 'title' => 'COM_PORTFOLIO_USER')); ?>
			</th>
			<th width="8%">
	...
	<? foreach ($people as $person) : ?>
		<tr>
			<td align="center">
				<?= @helper('grid.checkbox' , array('row' => $person)); ?>
			</td>
			<td align="left">
			...
			<td align="center">
				<?= @helper('grid.order', array('row' => $person, 'total' => $total)); ?>
            </td>
			<td align="center">
				<?= @helper('grid.enable', array('row' => $person)) ?>
            </td>
		</tr>
	<? endforeach; ?>
